<?php
  /**
   * Set user tv episode settings from Quick Menu.
  ...
  if($loggedIn === false) {
    ...
    try {
      ...
      $stmt = $dbh->prepare(
        "INSERT INTO users_tv_episodes (user_id, tv_episode_id, tmdb_id, imdb_id, watched, want_to_watch)" .
        " VALUES (:user_id, :tv_episode_id, :tmdb_id, :imdb_id, :watched, :want_to_watch)" .
