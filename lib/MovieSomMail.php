...
EOT;
    ...
    public function mailSpoilerUpdated($mailFrom, $mailTo, $tmdbId, $title) {
      // To send HTML mail, the Content-type header must be set
      $headers = array ('From' => $this->from,
        'MIME-Version' => '1.0',
        'Content-type' => 'text/html; charset=iso-8859-1',
        'To' => $mailTo,
        'Subject' => 'Movie spoiler updated');
    ...
    <td class="header container" >
      <div class="content">
        <table bgcolor="#333">
          <tr>
            <td><h6 class="collapse" style="color: white;">MovieSom</h6></td>
            <td align="right"><h6 class="collapse" style="color: #999">Spoiler update</h6></td>
          </tr>
        </table>
      </div>
    </td>
      ...
      <table>
        <tr>
          <td>
            <h3>Hi,</h3>
            <p class="lead">
              {$mailFrom} updated a spoiler for <a href="{$protocol}://app.moviesom.com/?tmdbMovieId={$tmdbId}">{$title}</a>.
              Read it at your own risk!
            </p>
            <p>You can also log in on <a href="{$protocol}://app.moviesom.com/">MovieSom.com</a> and find the recommendation in your Personal Collection overview.</p>
